    ...
    for j, word, old_word, freq in changed:
        ...
        while True:
            ...
            if i:
                ...
                stats[prev] += freq
                indices[prev][j] += 1
            # assuming a symbol sequence "A BC B", if "B C" is merged, increase the frequency of "BC B" however,
            # if the sequence is A BC BC, skip this step because the count of "BC BC" will be incremented by the
            # previous code block
